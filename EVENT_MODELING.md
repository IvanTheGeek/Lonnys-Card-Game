...
The Given/When/Then pattern serves two distinct purposes depending on slice type:
...
| ViewSlice | The relevant events | The filter / sort / transform criteria | The data shape (View) produced |
